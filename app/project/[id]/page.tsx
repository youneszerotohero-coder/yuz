...
const projectsData = [
  ...
  { 
    ...
    year: "2025",
    description: "  A beautifully animated title sequence combining archival footage with modern motion design techniques. The goal was to establish a somber yet inspiring tone before the event even began.",
  ...
  { 
    ...
    role: "Lead Editor",
    year: "2025",
    description: "An experimental content heavily relying on mixed media, datamoshing, and rhythmically synchronized edits. The visual tempo was meticulously crafted to match the beat drops.",
  ...
  { 
    ...
    role: "photographer",
    year: "2024",
    description: "A series of portraits capturing the raw emotion and personality of the subject. The lighting was carefully controlled to create a moody and intimate atmosphere.",
